 ...
 * @ignore
 */
export function internal_isByRef(virtualDocument: VirtualDocument): virtualDocument is VirtualDocument<ByRef> {
 ...
 * @ignore
 */
export function internal_isIsAclFor(virtualDocument: VirtualDocument): virtualDocument is VirtualDocument<IsAclFor> {
 ...
 * @ignore
 */
export function internal_isIsFoundOn(virtualDocument: VirtualDocument): virtualDocument is VirtualDocument<IsFoundOn> {
 ...
 * @ignore
 */
export function internal_isIsEnsuredOn(virtualDocument: VirtualDocument): virtualDocument is VirtualDocument<IsEnsuredOn> {
