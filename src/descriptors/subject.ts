...
export function internal_isByRef(virtualSubject: VirtualSubject): virtualSubject is VirtualSubject<ByRef> {
...
export function internal_isIsFoundIn(virtualSubject: VirtualSubject): virtualSubject is VirtualSubject<IsFoundIn> {
...
export function internal_isIsEnsuredIn(virtualSubject: VirtualSubject): virtualSubject is VirtualSubject<IsEnsuredIn> {
